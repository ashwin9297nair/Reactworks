        ...
        <div className='grid m-0 p-0'>
          <div className='lg:col-5 lg:col-offset-3 md-8 md:col-offset-1'>
            <div class="ps-transfer-box">
              <div className='flex align-items-center justify-content-center text-2xl font-bold text-indigo-500 p-2'>Swap</div>
              ...
              <div className='p-4'>
                ...
                <div className='grid p-0 pb-0'>
                  <div className='col-11'>
                    <div className="p-inputgroup my-2">
                      ...
                      />
                      <Button className='p-1 pr-3 pl-3' label="Max" onClick={() => {
                        this.handleMax();
                        setTimeout(() => {
                          this.getQuote();
                        }, 200);
                  ...
                  <div className='col-1 text-right flex justify-content-end align-items-center'>
                    <div className='ps-swap-box-border surface-100'>
                      <i className="pi pi-sort-alt text-indigo-500 "></i>
                    </div>
                ...
                <Dropdown
                  ...
                  filterBy="label"
                />
                <div className="p-inputgroup pt-3 pb-1">
                  <InputText
              ...
              <small id="username-help" className="p-error ml-3">
                ...
                <div className='flex justify-content-between mb-4 text-sm'>
                  <div>
                    Slippage Fee:
                  </div>
                  <div className='text-indigo-500'>
