...
function ChtBot() {
  const publicAddress = '0x4CD202065e25aE7dEb768D1E85739459e6e1AF68';
      ...
      <ChatBot
        ...
        steps={[
          ...
          },
          {
            id: '20',
            options: [
              { value: 1, label: 'YES', trigger: '38' },
              { value: 2, label: 'NO', trigger: '4' },
            ],
          },
          {
            id: '38',
            component: <Link exact to='./send'>Go to Transfer Page</Link>,
          },
          {
            id: '39',
            component: <Link exact to='./swap'>Go to Swapping Page</Link>,
          },
          {
            id: '21',
